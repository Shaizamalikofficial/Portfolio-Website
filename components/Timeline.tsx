...
const timelineItems: TimelineItem[] = [
  ...
  {
    title: 'Siber Koza & Aset AI Course',
    description: 'ML modules + hands-on tasks (2025)',
    category: 'learning',
  },
  {
    title: 'Xeven Solution AI Course',
    description: 'Python fundamentals, real-world AI applications, TensorFlow practice.',
    category: 'learning',
  },
  {
                ...
                >
                  <div className="glass rounded-lg p-6 hover:glass-strong transition-all duration-300">
                    <div className="flex items-center gap-3 mb-2">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-semibold ${item.category === 'learning'
